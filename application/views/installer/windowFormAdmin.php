...
<form id="form_admin">
    <p class="custom-form_field">
        <div class="custom-form_label">Введите имя сотрудника</div>
        <input placeholder="Имя" name="admin_name"/>
    </p>
    <p class="custom-form_field">
        <div class="custom-form_label">Введите фамилию сотрудника</div>
	...
	<p class="custom-form_field">
		<div class="custom-form_label">Введите пароль</div>
		<input type="password" placeholder="Пароль" name="admin_password"/>
	</p>
	<p class="custom-form_field">
		<div class="custom-form_label">Повторите пароль</div>
